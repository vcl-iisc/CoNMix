...
# STDA
python3 STDA.py --gpu_id '1' --s 0 --t 1 --dset office-home --net deit_s --max_epoch 50 --interval 50 --batch_size 128 --input_src src_train --wandb 1 --sdlr 1
python3 STDA.py --gpu_id '1' --s 0 --t 2 3 --dset office-home --net deit_s --max_epoch 50 --interval 50 --batch_size 128 --input_src src_train --wandb 1 --suffix noSdlr --sdlr 0

# python3 STDA.py --gpu_id '2,1,0' --s 1 --t 0 2 3 --dset office-home --net deit_s --max_epoch 50 --interval 50 --batch_size 128 --input_src src_train --wandb 1 --suffix noSdlr
# python3 STDA.py --gpu_id '2,1,0' --s 2 --t 0 1 3 --dset office-home --net deit_s --max_epoch 50 --interval 50 --batch_size 128 --input_src src_train --wandb 1 --suffix noSdlr
# python3 STDA.py --gpu_id '2,1,0' --s 3 --t 0 1 2 --dset office-home --net deit_s --max_epoch 50 --interval 50 --batch_size 128 --input_src src_train --wandb 1 --suffix noSdlr
