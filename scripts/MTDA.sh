...
python3 MTDA.py --dset office --s 0 --batch_size 64 --epoch 50 --interval 5 --net deit_s --gpu_id 0
python3 MTDA.py --dset office --s 1 --batch_size 64 --epoch 50 --interval 5 --net deit_s --gpu_id 1
python3 MTDA.py --dset office --s 2 --batch_size 64 --epoch 50 --interval 5 --net deit_s --gpu_id 0
